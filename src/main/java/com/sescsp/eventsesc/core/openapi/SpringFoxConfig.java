    ...
    public Docket apiDocketV1(){
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .tags(new Tag("Eventos", "Gerencia os eventos"),
                        new Tag("Sessões","Gerencia as sessões dos eventos"),
                        new Tag("Ingressos","Gerencia os ingressos das sessões")
                );
    }
    ...
    private List<ResponseMessage> globalPostPutResponseMessage() {
        return Arrays.asList(
                ...
                new ResponseMessageBuilder()
                        ...
                        .message("Requisição recusada porque o payload está em um formato não suportado")
                        .build()
        );
    }
